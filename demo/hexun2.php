...
$configs = array(
    ...
    'scan_urls' => array(
        ...
        "http://open.tool.hexun.com/MongodbNewsService/newsListPageByJson.jsp?id=100235806&s=30&cp=1&priority=0&callback=hx_json41513826662065"
    ),
    ...
    'content_url_regexes' => array(
        //"http://stock.hexun.com/2017-12-14/191976645.html",
...
$spider->on_start = function($phpspider)
{
    ...
    for ($i = 2; $i <= 2; $i++)
    {
        ...
        $phpspider->add_scan_url("http://open.tool.hexun.com/MongodbNewsService/newsListPageByJson.jsp?id=100235806&s=30&cp={$i}&priority=0&callback=hx_json41513826662065");
    }
};
